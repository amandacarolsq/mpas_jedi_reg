...
#
# !CALLING SEQUENCE:
#   ./runInitAtmos_IC_GFS.bash <EXP> <LABELI> <LABELF> <AREA> <RES>
#
...
#
# !EXAMPLE:
#   ./runInitAtmos_IC_GFS.bash EXP1 2025010100 2025010200 SaoPaulo 163842
#
# !REVISION HISTORY:
#   - Adaptado por Amanda.
